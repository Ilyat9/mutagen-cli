...
The mutation that survived the test suite (swallowed_error): A trailing number without a unit is silently ignored instead of raising an error, so "1h30" parses as one hour.
