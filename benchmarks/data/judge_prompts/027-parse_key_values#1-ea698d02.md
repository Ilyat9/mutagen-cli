<!-- id: parse_key_values#1-ea698d02 -->
...
The mutation that survived the test suite (wrong_operator): A value that itself contains an '=' character, like 'a=b=c', crashes instead of splitting on only the first '=' as documented.
