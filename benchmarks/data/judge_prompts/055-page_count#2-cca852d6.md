...
The mutation that survived the test suite (boundary_condition): page_count silently returns 0 for negative totals instead of treating them as invalid, masking upstream bugs that pass a negative count.
