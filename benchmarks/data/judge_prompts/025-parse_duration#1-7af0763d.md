...
The mutation that survived the test suite (other): Durations with surrounding whitespace like ' 1h30m ' are rejected instead of parsed, because the input is no longer trimmed before parsing.
