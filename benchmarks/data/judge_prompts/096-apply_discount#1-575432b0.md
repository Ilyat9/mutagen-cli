...
The mutation that survived the test suite (wrong_operator): The discount cap is ignored and instead the larger of the computed discount and the cap is applied, so capped discounts overcharge the customer's savings.
