...
The mutation that survived the test suite (boundary_condition): has_prev reports true even on the first page, so pagers show a 'previous' control that leads nowhere.
