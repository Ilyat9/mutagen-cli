...
The mutation that survived the test suite (boundary_condition): Text exactly as long as the limit gets truncated and suffixed anyway instead of being returned unchanged.
