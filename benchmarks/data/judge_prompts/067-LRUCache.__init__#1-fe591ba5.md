<!-- id: LRUCache.__init__#1-fe591ba5 -->
...
The mutation that survived the test suite (boundary_condition): A capacity of 0 is accepted instead of rejected, creating a cache that can never usefully hold anything.
