...
The mutation that survived the test suite (missing_invalidation): Reading a key no longer refreshes its recency, so recently-read entries are evicted first.
