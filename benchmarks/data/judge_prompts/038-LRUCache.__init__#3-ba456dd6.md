<!-- id: LRUCache.__init__#3-ba456dd6 -->
...
The mutation that survived the test suite (wrong_default): The default capacity is silently changed from 128 to 1, so caches created without an explicit capacity evict everything after the very first insert.
