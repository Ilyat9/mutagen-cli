...
The mutation that survived the test suite (swallowed_error): Duration strings with a trailing number but no unit (e.g. '1h30') silently succeed instead of raising an error, returning only the hours portion
