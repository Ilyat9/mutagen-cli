...
The mutation that survived the test suite (wrong_operator): has_next always returns False, so callers never see a next-page indicator even when more pages exist
