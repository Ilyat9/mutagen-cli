...
The mutation that survived the test suite (boundary_condition): On the first page, has_prev incorrectly reports True instead of False, suggesting there is a previous page when there isn't.
