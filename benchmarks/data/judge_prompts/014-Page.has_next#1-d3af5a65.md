...
The mutation that survived the test suite (boundary_condition): has_next stays true on the last page, so pagers try to fetch a page beyond the end of the data.
