<!-- id: LRUCache.__init__#2-88ec5910 -->
...
The mutation that survived the test suite (wrong_default): Hit and miss counters start at 1 instead of 0, so freshly created caches report inflated hit/miss statistics before any access occurs.
