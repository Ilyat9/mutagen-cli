<!-- id: LRUCache.__init__#3-74ba6f80 -->
...
The mutation that survived the test suite (wrong_default): Hit counter starts at one instead of zero, so hit statistics are always inflated.
