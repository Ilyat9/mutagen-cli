...
The mutation that survived the test suite (wrong_operator): Every cache lookup, hit or miss, is counted as a hit, so hit/miss statistics become meaningless.
