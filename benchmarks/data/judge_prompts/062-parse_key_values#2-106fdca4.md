<!-- id: parse_key_values#2-106fdca4 -->
...
The mutation that survived the test suite (wrong_default): An empty input string now returns None instead of an empty dict, breaking any caller that iterates or does membership checks on the result.
