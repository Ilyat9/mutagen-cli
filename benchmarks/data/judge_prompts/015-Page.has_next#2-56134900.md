...
The mutation that survived the test suite (inverted_condition): has_next is backwards: it reports no next page while more pages remain, and reports a next page once you're past the end.
