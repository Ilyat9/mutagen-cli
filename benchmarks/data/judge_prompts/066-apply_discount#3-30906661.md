...
The mutation that survived the test suite (wrong_default): Passing percent=None now raises an error instead of being treated as no discount, breaking callers that rely on this documented fallback behavior.
