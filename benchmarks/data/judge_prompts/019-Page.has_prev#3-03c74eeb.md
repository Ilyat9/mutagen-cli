...
The mutation that survived the test suite (inverted_condition): has_prev is inverted and is essentially always false, so the previous-page control never appears even when earlier pages exist.
