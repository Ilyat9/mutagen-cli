...
The mutation that survived the test suite (wrong_operator): A max_discount cap acts as a minimum instead of a maximum, so discounts meant to be capped can end up larger than intended.
