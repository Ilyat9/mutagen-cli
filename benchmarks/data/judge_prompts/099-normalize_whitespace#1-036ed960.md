<!-- id: normalize_whitespace#1-036ed960 -->
...
The mutation that survived the test suite (none_handling): Falsy values other than None (like empty strings or 0) are turned into empty strings instead of being normalized normally.
