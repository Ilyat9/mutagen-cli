<!-- id: parse_key_values#1-179f51f6 -->
...
The mutation that survived the test suite (other): Values are no longer stripped of surrounding whitespace, so keys like 'a' end up mapped to ' 1' instead of '1'.
