...
The mutation that survived the test suite (other): The reported total counts only the items on the current page instead of the whole collection, so page counts and has_next are wrong.
