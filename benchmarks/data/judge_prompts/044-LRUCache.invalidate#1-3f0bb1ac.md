<!-- id: LRUCache.invalidate#1-3f0bb1ac -->
...
The mutation that survived the test suite (wrong_operator): invalidate() reports success even when the key was never present, since it always returns True regardless of whether a deletion happened
