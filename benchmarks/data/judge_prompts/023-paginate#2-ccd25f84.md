...
The mutation that survived the test suite (boundary_condition): paginate() accepts per_page=0, silently returning an empty page forever instead of rejecting the invalid input.
