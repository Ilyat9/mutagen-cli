...
The mutation that survived the test suite (off_by_one): Truncated text is cut one character shorter than necessary before the suffix is appended, silently discarding an extra character of content that would have fit within the limit.
