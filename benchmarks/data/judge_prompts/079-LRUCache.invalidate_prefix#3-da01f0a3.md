<!-- id: LRUCache.invalidate_prefix#3-da01f0a3 -->
...
The mutation that survived the test suite (wrong_operator): Invalidating by prefix also drops keys that merely contain the prefix anywhere, wiping unrelated entries.
