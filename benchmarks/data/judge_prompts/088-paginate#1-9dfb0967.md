...
The mutation that survived the test suite (off_by_one): Pages after the first start one item too early, so each page repeats the last item of the previous page.
