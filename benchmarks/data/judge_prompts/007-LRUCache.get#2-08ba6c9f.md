...
The mutation that survived the test suite (other): A cache hit is recorded as a miss, so hit/miss statistics used for monitoring cache effectiveness are wrong.
