...
The mutation that survived the test suite (swallowed_error): A duration with a trailing number and no unit, like '1h30', silently drops the trailing amount instead of raising, so the parsed duration is smaller than what the caller wrote.
