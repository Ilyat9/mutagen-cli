...
The mutation that survived the test suite (wrong_default): Passing percent=None, which is documented as 'no discount', instead applies a full 100% discount, making the item free.
