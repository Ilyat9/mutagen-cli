...
The mutation that survived the test suite (boundary_condition): Requesting per_page=0 is silently accepted and returns an empty page instead of raising an error.
