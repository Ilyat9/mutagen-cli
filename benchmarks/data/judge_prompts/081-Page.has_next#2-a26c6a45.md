...
The mutation that survived the test suite (wrong_operator): has_next is computed from the item count instead of the page count, so it is true for almost every page.
