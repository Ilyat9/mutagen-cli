<!-- id: LRUCache.invalidate_prefix#2-d5644bfa -->
...
The mutation that survived the test suite (missing_invalidation): invalidate_prefix silently does nothing (removes no keys) but still reports a truthy-looking count based on matches found before deletion is skipped
