<!-- id: LRUCache.invalidate_prefix#1-79433109 -->
...
The mutation that survived the test suite (off_by_one): Invalidating by prefix reports one fewer key removed than it actually dropped.
