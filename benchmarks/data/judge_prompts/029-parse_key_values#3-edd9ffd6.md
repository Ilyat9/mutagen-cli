<!-- id: parse_key_values#3-edd9ffd6 -->
...
The mutation that survived the test suite (other): When the same key appears twice, the first value silently wins instead of the later one overriding it as documented.
