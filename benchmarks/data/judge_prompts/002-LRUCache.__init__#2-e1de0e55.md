<!-- id: LRUCache.__init__#2-e1de0e55 -->
...
The mutation that survived the test suite (wrong_default): The default cache capacity is smaller than documented (100 instead of 128), so callers relying on the default silently get less caching headroom and see extra evictions.
