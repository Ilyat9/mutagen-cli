...
The mutation that survived the test suite (other): Whitespace is no longer stripped from the input, so durations with surrounding spaces are rejected as invalid characters.
