<!-- id: LRUCache.invalidate_prefix#2-f040606b -->
...
The mutation that survived the test suite (off_by_one): Invalidating by prefix leaves the first matching key in the cache, so stale values keep being served.
