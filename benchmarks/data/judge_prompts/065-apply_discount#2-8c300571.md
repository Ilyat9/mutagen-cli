...
The mutation that survived the test suite (boundary_condition): Negative percent values are silently accepted instead of raising an error, since the boundary check no longer rejects them.
