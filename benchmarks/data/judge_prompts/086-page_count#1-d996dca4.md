...
The mutation that survived the test suite (off_by_one): Partial final pages are dropped, so a partly-filled last page of items becomes unreachable (11 items at 5 per page reports 2 pages instead of 3).
