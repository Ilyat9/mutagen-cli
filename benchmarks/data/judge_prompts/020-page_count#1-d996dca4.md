...
The mutation that survived the test suite (off_by_one): page_count silently drops the ceiling: 11 items at 5 per page reports 2 pages instead of 3, so the last partial page of results is missed entirely.
