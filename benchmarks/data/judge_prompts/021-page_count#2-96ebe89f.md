...
The mutation that survived the test suite (boundary_condition): page_count rejects a valid per_page of exactly 1, so callers who page one item at a time get an unexpected ValueError.
