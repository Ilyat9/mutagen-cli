<!-- id: LRUCache.invalidate_prefix#1-d5644bfa -->
...
The mutation that survived the test suite (missing_invalidation): invalidate_prefix reports how many keys it removed but never actually deletes them, so cached values keep being served after they should have been invalidated.
