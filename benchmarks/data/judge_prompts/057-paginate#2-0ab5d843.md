...
The mutation that survived the test suite (off_by_one): The 'total' count reported on a page is always one less than the true number of items, making has_next and other calculations based on total slightly wrong.
