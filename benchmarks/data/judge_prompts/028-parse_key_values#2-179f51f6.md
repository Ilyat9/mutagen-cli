<!-- id: parse_key_values#2-179f51f6 -->
...
The mutation that survived the test suite (other): Leading and trailing whitespace around values is preserved instead of stripped, so ' a = 1 ' keeps stray spaces in the parsed value.
