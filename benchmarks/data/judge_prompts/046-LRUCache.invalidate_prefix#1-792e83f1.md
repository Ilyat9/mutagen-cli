<!-- id: LRUCache.invalidate_prefix#1-792e83f1 -->
...
The mutation that survived the test suite (wrong_default): invalidate_prefix always reports zero removals regardless of how many keys were actually deleted, so callers relying on the count get wrong information
