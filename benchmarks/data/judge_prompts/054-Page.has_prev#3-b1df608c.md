...
The mutation that survived the test suite (inverted_condition): has_prev is inverted, returning True only on the first page and False everywhere else.
