<!-- id: parse_key_values#2-87a134bd -->
...
The mutation that survived the test suite (wrong_operator): Earlier occurrences of a duplicate key win instead of the last one overriding.
