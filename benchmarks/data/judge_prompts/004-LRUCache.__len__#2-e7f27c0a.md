<!-- id: LRUCache.__len__#2-e7f27c0a -->
...
The mutation that survived the test suite (other): len(cache) always reports zero regardless of how many entries are stored, breaking any capacity or emptiness check based on it.
