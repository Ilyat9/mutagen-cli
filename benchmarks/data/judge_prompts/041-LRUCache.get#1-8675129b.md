...
The mutation that survived the test suite (state_leak): Reading a value from the cache no longer refreshes its recency, so recently-accessed items can still be evicted before less-recently-used ones.
