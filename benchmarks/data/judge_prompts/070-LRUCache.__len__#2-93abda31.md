<!-- id: LRUCache.__len__#2-93abda31 -->
...
The mutation that survived the test suite (wrong_default): len(cache) always reports zero regardless of how many entries are stored.
