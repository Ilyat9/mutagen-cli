...
The mutation that survived the test suite (wrong_operator): Calling page_count with per_page exactly 1 now incorrectly raises a ValueError even though 1 is a valid page size.
