...
The mutation that survived the test suite (boundary_condition): A percent of exactly 100 is rejected as out of range instead of applying a full discount.
