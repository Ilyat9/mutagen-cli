...
The mutation that survived the test suite (boundary_condition): The cache evicts an entry as soon as it reaches capacity, so it only ever holds capacity-1 items.
