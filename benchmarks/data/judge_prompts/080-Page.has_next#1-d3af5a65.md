...
The mutation that survived the test suite (boundary_condition): has_next stays true on the final page, so callers keep requesting a page that does not exist.
